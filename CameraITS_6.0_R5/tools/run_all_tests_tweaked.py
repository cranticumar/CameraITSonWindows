...
def main():
    ...
    parser.add_argument('-c', '--cameraid', dest='cameraid', default=None, type=int,
                        required=False, help='0 or 1')
    parser.add_argument('-t', '--test', dest='tname', default='all',
                        required=False, help='run all tests or induvidual tests')
    parser.add_argument('-l', '--list', dest='tclist', default=False,
                        required=False, help='parameter to list all tests')
    parser.add_argument('-n', '--number', dest='iterations', default=1, type=int,
    ...
    if tclist:
        for t in tests:
            print "{scene} {tcname}".format(scene=t[0], tcname=t[1])
        exit(1)
